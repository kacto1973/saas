        ...
        <div className="container">
          ...
          >
            <h3
              ...
              max-w-lg text-center text-p4 max-md:mb-11
            max-sm:max-w-sm"
            >
            ...
            border-s4/25 bg-s1/50 p-2 backdrop-blur-[6px]
            max-md:w-[310px]"
            >
              <button
              ...
              >
                ...
                {index === 1 && (
                  <p
                    ...
                    before:content-['-'] before:mx-2.5 after:mx-2.5 after:content-['-'] "
                  >
                    Limited time offer
                  </p>
                )}
